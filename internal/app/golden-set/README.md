# CodeRig operator golden-set

Golden input/output pairs for evaluating the CodeRig `operator` agent driven
as the active operator primer built by the CodeRig rig.
